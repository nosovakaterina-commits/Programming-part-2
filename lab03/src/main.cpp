...
int main() {
    Student student(5, 1, 92.3, true, 45);
    ...
    std::cout << "Can receive scholarship: " << (student.canReceiveScholarship() ? "Yea" : "No") << std::endl;
    ...
    std::cout << "Is exelent student? : " << (student.isExcellentStudent() ? "Yea" : "No") << std::endl;
    std::cout << " Can receive scholarship now? : " << (student.canReceiveScholarship() ? "Yea" : "No") << std::endl;
