...
Student::Student() 
    : name("Unnamed student"), id(0), course(1), averageGrade(0.0), scholarship(false), absences(0) {
    }

Student::Student(const char* name, int id, int course, double averageGrade, bool scholarship, int absences)
: name(name),
id(id >= 0 ? id : 0),
